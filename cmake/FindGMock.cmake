# FindGMock.cmake This module finds the Google Mock library
...
find_path(
  GMOCK_INCLUDE_DIR
  NAMES gmock/gmock.h
  HINTS ${GTEST_INCLUDE_DIR} ${GTEST_ROOT}
  PATHS /usr/local/include /usr/include)

find_library(
  GMOCK_LIBRARY
  NAMES gmock
  HINTS ${GTEST_LIBRARY_DIR} ${GTEST_ROOT}
...
if(GMOCK_FOUND)
  ...
  message(
    WARNING
      "Google Mock not found, please install it or set the paths correctly.")
endif()

# Provide the version information if necessary set(GMOCK_VERSION "x.y.z") #
