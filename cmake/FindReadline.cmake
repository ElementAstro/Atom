# * Try to find the Readline library Once done, this will define Readline_FOUND
#   - System has Readline Readline_INCLUDE_DIRS - The Readline include
#   directories Readline_LIBRARIES - The libraries needed to use Readline
...
if(WIN32)
  ...
  list(APPEND CMAKE_PREFIX_PATH "C:/Program Files/readline" "C:/readline")

  # **MSYS2 environment paths** First, try to get MSYS2 paths from the PATH
  ...
  if(DEFINED ENV{PATH})
    ...
    if(_msys_prefixes_from_env_path)
      ...
      message(
        STATUS "Found MSYS2 prefixes from PATH: ${_msys_prefixes_from_env_path}"
      )
    endif()
  endif()
...
find_path(
  ...
  PATHS ${READLINE_ROOT}/include /usr/include /usr/local/include
...
if(WIN32)
  find_library(
    ...
    PATHS ${READLINE_ROOT}/lib /usr/lib /usr/local/lib /opt/local/lib /sw/lib)
...
find_package_handle_standard_args(Readline DEFAULT_MSG Readline_LIBRARY
                                  Readline_INCLUDE_DIR)
...
mark_as_advanced(Readline_INCLUDE_DIR Readline_LIBRARY Readline_NCURSES_LIBRARY
                 Readline_TERMCAP_LIBRARY)
