# cmake/CrossPlatformSupport.cmake Enhanced cross-platform support module
...
function(detect_platform_capabilities)
  ...
  set(ATOM_PLATFORM_WINDOWS
      FALSE
      PARENT_SCOPE)
  set(ATOM_PLATFORM_LINUX
      FALSE
      PARENT_SCOPE)
  set(ATOM_PLATFORM_MACOS
      FALSE
      PARENT_SCOPE)
  set(ATOM_PLATFORM_WSL
      FALSE
      PARENT_SCOPE)
  set(ATOM_PLATFORM_MINGW
      FALSE
      PARENT_SCOPE)
  set(ATOM_PLATFORM_CYGWIN
      FALSE
      PARENT_SCOPE)
...
function(detect_compiler_features)
  ...
  message(
    STATUS
      "Compiler features detected: C++23=${HAS_CXX23}, LTO=${HAS_LTO}, ASAN=${HAS_ASAN}"
  )
endfunction()
...
function(detect_platform_libraries)
  ...
  if(ATOM_PLATFORM_WINDOWS)
    ...
    set(ATOM_PLATFORM_LIBRARIES
        ${WS2_32_LIBRARY} ${WSOCK32_LIBRARY} ${IPHLPAPI_LIBRARY}
        ${PSAPI_LIBRARY}
        PARENT_SCOPE)
  endif()
  ...
  if(ATOM_PLATFORM_LINUX)
    ...
    set(ATOM_PLATFORM_LIBRARIES
        ${PTHREAD_LIBRARY} ${DL_LIBRARY} ${RT_LIBRARY}
        PARENT_SCOPE)
  endif()
  ...
  if(ATOM_PLATFORM_MACOS)
    ...
    set(ATOM_PLATFORM_LIBRARIES
        ${COREFOUNDATION_LIBRARY} ${IOKIT_LIBRARY} ${SECURITY_LIBRARY}
        PARENT_SCOPE)
  endif()
endfunction()
...
function(apply_platform_compiler_flags TARGET_NAME)
  if(ATOM_PLATFORM_WINDOWS)
    if(MSVC)
      ...
      target_compile_options(
        ${TARGET_NAME}
        PRIVATE $<$<CONFIG:Release>:/Ox> # Maximum optimization
      ...
      target_compile_options(
        ${TARGET_NAME}
        PRIVATE $<$<CONFIG:Debug>:/Od> # Disable optimization
    ...
    if(HAS_MARCH_NATIVE)
      target_compile_options(
        ${TARGET_NAME} PRIVATE $<$<CONFIG:Release>:-march=native>
    ...
    # Debug-specific flags
    target_compile_options(
      ${TARGET_NAME} PRIVATE $<$<CONFIG:Debug>:-O0> $<$<CONFIG:Debug>:-g>
                             $<$<CONFIG:Debug>:-DDEBUG>)
  endif()
endfunction()
