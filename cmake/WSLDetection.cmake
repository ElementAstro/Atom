...
function(detect_wsl RESULT_VAR)
  ...
  if(EXISTS "/proc/version")
    ...
    if(VERSION_CONTENT MATCHES "Microsoft"
       OR VERSION_CONTENT MATCHES "WSL"
       OR VERSION_CONTENT MATCHES "microsoft-standard")
      set(${RESULT_VAR}
          TRUE
          PARENT_SCOPE)
      return()
  ...
  if(EXISTS "/proc/sys/kernel/osrelease")
    ...
    if(KERNEL_RELEASE MATCHES "Microsoft"
       OR KERNEL_RELEASE MATCHES "WSL"
       OR KERNEL_RELEASE MATCHES "microsoft-standard")
      set(${RESULT_VAR}
          TRUE
          PARENT_SCOPE)
      return()
  ...
  if(UNAME_R_OUTPUT MATCHES "Microsoft"
     OR UNAME_R_OUTPUT MATCHES "WSL"
     OR UNAME_R_OUTPUT MATCHES "microsoft-standard")
    set(${RESULT_VAR}
        TRUE
        PARENT_SCOPE)
    return()
  ...
  execute_process(
    COMMAND uname -a
    OUTPUT_VARIABLE UNAME_A_OUTPUT
    ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE)
  if(UNAME_A_OUTPUT MATCHES "Microsoft"
     OR UNAME_A_OUTPUT MATCHES "WSL"
     OR UNAME_A_OUTPUT MATCHES "microsoft-standard")
    set(${RESULT_VAR}
        TRUE
        PARENT_SCOPE)
    return()
