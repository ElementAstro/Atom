...
# Package naming
set(ATOM_PACKAGE_BASENAME "${ATOM_PACKAGE_NAME}-${ATOM_VERSION}-${ATOM_PLATFORM}-${ATOM_ARCH}")
...
set(ATOM_COMPONENTS
    algorithm async components connection containers error
    image io log memory meta search secret serial
    sysinfo system type utils web
)

# Component dependencies mapping
set(ATOM_COMPONENT_DEPS_algorithm "error")
set(ATOM_COMPONENT_DEPS_async "error;log")
set(ATOM_COMPONENT_DEPS_components "error;log;type")
set(ATOM_COMPONENT_DEPS_connection "error;log;async")
set(ATOM_COMPONENT_DEPS_containers "error;type")
set(ATOM_COMPONENT_DEPS_error "")
set(ATOM_COMPONENT_DEPS_image "error;log;io")
set(ATOM_COMPONENT_DEPS_io "error;log")
set(ATOM_COMPONENT_DEPS_log "error")
set(ATOM_COMPONENT_DEPS_memory "error")
set(ATOM_COMPONENT_DEPS_meta "error;type")
set(ATOM_COMPONENT_DEPS_search "error;algorithm")
set(ATOM_COMPONENT_DEPS_secret "error;log")
set(ATOM_COMPONENT_DEPS_serial "error;log;io")
set(ATOM_COMPONENT_DEPS_sysinfo "error;log")
set(ATOM_COMPONENT_DEPS_system "error;log;sysinfo")
set(ATOM_COMPONENT_DEPS_type "error")
set(ATOM_COMPONENT_DEPS_utils "error;log;type")
set(ATOM_COMPONENT_DEPS_web "error;log;async;connection")
...
function(atom_setup_linux_packaging)
    set(CPACK_GENERATOR "TGZ;DEB;RPM" PARENT_SCOPE)

    # Debian package configuration
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER ${ATOM_PACKAGE_CONTACT} PARENT_SCOPE)
    set(CPACK_DEBIAN_PACKAGE_SECTION "libdevel" PARENT_SCOPE)
    set(CPACK_DEBIAN_PACKAGE_PRIORITY "optional" PARENT_SCOPE)
    set(CPACK_DEBIAN_PACKAGE_DEPENDS "libssl-dev, zlib1g-dev, libsqlite3-dev, libfmt-dev" PARENT_SCOPE)

    # RPM package configuration
    set(CPACK_RPM_PACKAGE_GROUP "Development/Libraries" PARENT_SCOPE)
    set(CPACK_RPM_PACKAGE_LICENSE "GPL-3.0" PARENT_SCOPE)
    set(CPACK_RPM_PACKAGE_REQUIRES "openssl-devel, zlib-devel, sqlite-devel, fmt-devel" PARENT_SCOPE)
endfunction()
...
function(atom_create_meta_package PACKAGE_NAME COMPONENT_LIST)
    message(STATUS "Creating meta-package: ${PACKAGE_NAME} with components: ${COMPONENT_LIST}")
...
function(atom_generate_package_manifest COMPONENT_NAME OUTPUT_FILE)
    ...
    file(APPEND ${OUTPUT_FILE} "  \"description\": \"${ATOM_COMPONENT_DESC_${COMPONENT_NAME}}\",\n")
...
function(atom_create_portable_package)
    ...
    install(TARGETS ${ATOM_ALL_TARGETS}
    ...
    # Copy headers
    install(DIRECTORY ${CMAKE_SOURCE_DIR}/atom/
...
function(atom_create_windows_launcher PORTABLE_DIR)
    file(WRITE ${PORTABLE_DIR}/atom-env.bat
        "@echo off\n"
        "set ATOM_ROOT=%~dp0\n"
...
function(atom_create_unix_launcher PORTABLE_DIR)
    file(WRITE ${PORTABLE_DIR}/atom-env.sh
        "#!/bin/bash\n"
    ...
    file(CHMOD ${PORTABLE_DIR}/atom-env.sh
