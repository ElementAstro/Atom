...
void basicServerExample() {
    Logger::log(Logger::INFO, "Example1", "=== Basic FIFOServer Usage ===");
    ...
    try {
        ...
        for (int i = 1; i <= 5; ++i) {
            ...
            if (server.sendMessage(message)) {
                Logger::log(Logger::SUCCESS, "Example1", "Sent: " + message);
            } else {
    ...
    Logger::log(Logger::INFO, "Example1", "Basic server example completed\n");
}
...
void asyncMessageExample() {
    Logger::log(Logger::INFO, "Example4", "=== Async Message Sending ===");
    ...
    Logger::log(Logger::INFO, "Example4", "Async message example completed\n");
}

// Example 5: Batch message sending with ranges
void batchMessageExample() {
    Logger::log(Logger::INFO, "Example5", "=== Batch Message Sending ===");
    ...
    Logger::log(Logger::INFO, "Example5", "Batch message example completed\n");
}

// Example 6: Messageable concept with different types
void messageableTypesExample() {
    Logger::log(Logger::INFO, "Example6", "=== Messageable Types ===");
    ...
    try {
        ...
        Logger::log(Logger::SUCCESS, "Example6", "Sent std::string");

        // Send string literal (const char*)
        server.sendMessage("String literal message");
        Logger::log(Logger::SUCCESS, "Example6", "Sent string literal");

        // Send numeric types (converted via std::to_string)
        server.sendMessage(42);
        Logger::log(Logger::SUCCESS, "Example6", "Sent int: 42");

        server.sendMessage(3.14159);
        Logger::log(Logger::SUCCESS, "Example6", "Sent double: 3.14159");

        server.sendMessage(100L);
        Logger::log(Logger::SUCCESS, "Example6", "Sent long: 100");

        // Send with priority
        server.sendMessage(999, atom::connection::MessagePriority::Critical);
        Logger::log(Logger::SUCCESS, "Example6", "Sent critical int: 999");
...
void callbacksExample() {
    ...
    Logger::log(Logger::INFO, "Example7", "Callbacks example completed\n");
}

// Example 8: Statistics tracking
void statisticsExample() {
    Logger::log(Logger::INFO, "Example8", "=== Statistics Tracking ===");
    ...
    try {
        ...
        Logger::log(Logger::INFO, "Example8", "Statistics reset");
    ...
    Logger::log(Logger::INFO, "Example8", "Statistics example completed\n");
}

// Example 9: Queue management
void queueManagementExample() {
    Logger::log(Logger::INFO, "Example9", "=== Queue Management ===");
    ...
    try {
        ...
        // Fill the queue
        Logger::log(Logger::INFO, "Example9", "Filling queue with messages...");
        for (int i = 0; i < 20; ++i) {
...
void logLevelExample() {
    Logger::log(Logger::INFO, "Example10", "=== Log Level Configuration ===");
    ...
    try {
        ...
        for (auto level : levels) {
            ...
            Logger::log(Logger::INFO, "Example10",
        ...
        Logger::log(Logger::ERR, "Example10",
                    "Exception: " + std::string(e.what()));
    }

    Logger::log(Logger::INFO, "Example10", "Log level example completed\n");
}

// Example 11: Move semantics
void moveSemanticsExample() {
    Logger::log(Logger::INFO, "Example11", "=== Move Semantics ===");
    ...
    try {
        ...
        Logger::log(Logger::ERR, "Example11",
                    "Exception: " + std::string(e.what()));
    }
