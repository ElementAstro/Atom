...
// Example 1: Basic async SocketHub usagevoid basicAsyncSocketHubExample() {
...
// Example 3: Message and event handlersvoid handlersExample() {
...
// Example 4: Group managementvoid groupManagementExample() {
...
// Example 5: Authenticationvoid authenticationExample() {
...
// Example 6: Client metadatavoid clientMetadataExample() {
...
try {
    ...
    for (size_t clientId : clients) {
        ...
        Logger::log(Logger::LOG_INFO, "Example6",
                    "Client " + std::to_string(clientId) + " - Role: " + role +
                        ", IP: " + ip);
    }
...
// Example 7: Statistics and monitoringvoid statisticsExample() {
...
// Example 8: Logging configurationvoid loggingExample() {
...
// Example 9: Message typesvoid messageTypesExample() {
Logger::log(Logger::LOG_INFO, "Example9", "=== Message Types ===");

try {
    atom::async::connection::SocketHub hub;

    hub.addMessageHandler([](const atom::async::connection::Message& msg,
                             size_t clientId) {
        std::string typeStr;
        switch (msg.type) {
...
// Example 10: Client managementvoid clientManagementExample() {
...
// Example 11: Server restartvoid serverRestartExample() {
