...
void messageHandlerExample() {
    ...
    try {
        ...
        // Add message handler
        server.addHandler([&messageCount](const std::string& message,
...
void removeHandlerExample() {
    Logger::log(Logger::LOG_INFO, "Example5", "=== Remove Handlers ===");
    ...
    try {
        ...
        Logger::log(Logger::LOG_INFO, "Example5",
                    "Added handler with ID: " + std::to_string(handlerId));
