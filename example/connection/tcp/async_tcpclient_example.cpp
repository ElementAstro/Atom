...
// Example 1: Basic async TCP clientvoid basicAsyncTcpClientExample() {
...
try {
    ...
    Logger::log(
        ...
        "Created async TcpClient, state: " + stateToString(client.getState()));
...
// Example 3: SSL/TLS connectionvoid sslConnectionExample() {
...
// Example 4: Proxy supportvoid proxyExample() {
...
try {
    ...
    Logger::log(Logger::LOG_INFO, "Example4", "  - Host: " + proxyConfig.host);
...
// Example 5: Callbacksvoid callbacksExample() {
...
// Example 6: Auto reconnectionvoid autoReconnectExample() {
...
// Example 7: Heartbeat mechanismvoid heartbeatExample() {
...
try {
    ...
    client.setHeartbeatCallback([](bool success) {
        Logger::log(success ? Logger::LOG_DEBUG : Logger::LOG_WARNING,
                    "Heartbeat", success ? "Heartbeat OK" : "Heartbeat failed");
    });
...
// Example 8: Request-response patternvoid requestResponseExample() {
...
// Example 9: Statistics trackingvoid statisticsExample() {
...
try {
    ...
    if (client.isConnected()) {
        ...
        Logger::log(Logger::LOG_INFO, "Example9",
                    "Connected for: " +
                        std::to_string(connectedDuration.count()) + " seconds");
...
// Example 10: Complete async workflowvoid completeWorkflowExample() {
