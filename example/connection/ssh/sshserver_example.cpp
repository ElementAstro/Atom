...
// Example 1: Basic SSH servervoid basicServerExample() {
...
// Example 2: Host key configurationvoid hostKeyExample() {
...
try {
    ...
    Logger::log(Logger::LOG_INFO, "Example2", "Set host key: " + hostKeyPath);
...
// Example 3: Authentication configurationvoid authenticationExample() {
...
// Example 4: IP filteringvoid ipFilteringExample() {
...
try {
    ...
    for (const auto& ip : testIPs) {
        ...
        Logger::log(allowed ? Logger::LOG_SUCCESS : Logger::LOG_WARNING,
                    "Example4", ip + ": " + (allowed ? "ALLOWED" : "BLOCKED"));
    }
...
// Example 5: Subsystem configurationvoid subsystemExample() {
...
// Example 6: Connection callbacksvoid callbacksExample() {
...
try {
    ...
    server.setAuthFailureCallback([](const std::string& username,
        ...
        Logger::log(Logger::LOG_WARNING, "AuthFail",
                    "Auth failed - User: " + username + ", IP: " + clientIp +
                        ", Method: " + method);
    });
...
// Example 7: Security settingsvoid securitySettingsExample() {
...
try {
    ...
    // Set ciphers
    std::vector<std::string> ciphers = {"aes256-gcm@openssh.com",
...
// Example 9: Banner and MOTDvoid bannerExample() {
...
// Example 10: Complete server configurationvoid completeConfigExample() {
