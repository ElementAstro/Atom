...
// Custom data type for demonstrationstruct UserData {
int id;
std::string name;
double score;
...
// Helper function to print query resultstemplate <typename T>
...
// Helper function to print entriestemplate <typename EntryType>
...
// Simulate access patternsvoid simulate_accesses(
    ...
    int main() {
        ...
        atom::type::CountingHashTable<std::string, std::string> string_table(
            8, 100);
        ...
        std::cout << "  apple: "
                  << string_table.getAccessCount("apple").value_or(0)
                  << std::endl;
        std::cout << "  banana: "
                  << string_table.getAccessCount("banana").value_or(0)
                  << std::endl;
        std::cout << "  cherry: "
                  << string_table.getAccessCount("cherry").value_or(0)
                  << std::endl;
        ...
        std::cout << "Inserted batch of 3 items (including 1 update)"
                  << std::endl;
        ...
        std::cout << "Erased 'banana': " << (erased ? "yes" : "no")
                  << std::endl;
        ...
        for (size_t i = 0; i < top_users.size(); ++i) {
            ...
            std::cout << "  " << i + 1 << ". " << user_data.value
                      << " (accessed " << user_data.count << " times)"
                      << std::endl;
        }
        std::cout << std::endl;
        ...
        std::cout << "Starting auto-sorting with 500ms interval..."
                  << std::endl;
        ...
        std::cout << "Entries after clearing: " << after_clear.size()
                  << std::endl;
