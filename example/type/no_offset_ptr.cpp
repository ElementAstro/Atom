...
// Sample class to demonstrate UnshiftedPtr usageclass Resource {
private:
std::string name_;
int value_;
...
Resource(std::string name, int value, bool* destroyed_flag = nullptr)
    : name_(std::move(name)), value_(value), destroyed_flag_(destroyed_flag) {
...
// Example 1: Basic usagevoid basic_usage_example() {
...
std::cout << "Value after update: " << custom_resource->getValue() << std::endl;
...
// Example 2: Reset and Emplacevoid reset_emplace_example() {
...
// Example 3: Thread Safety with Mutexvoid thread_safety_mutex_example() {
...
// Example 4: Lock-Free Atomic Operationsvoid lock_free_atomic_example() {
...
// Example 5: Move Semanticsvoid move_semantics_example() {
...
// Example 6: Error Handlingvoid error_handling_example() {
...
std::cout << "UnshiftedPtr has value: " << (resource.has_value() ? "yes" : "no")
          << std::endl;
...
// Example 7: Lifetime Monitoringvoid lifetime_monitoring_example() {
...
// Create a nested scope
{
    ...
    std::cout << "Resource initialized, monitoring destruction..." << std::endl;
    std::cout << "Resource destroyed: " << (resource_destroyed ? "yes" : "no")
              << std::endl;
...
// Example 8: Complex Typesvoid complex_types_example() {
...
// Example 9: UnshiftedPtr with Primitivesvoid primitive_types_example() {
...
std::cout << "Boolean value: " << (*bool_ptr ? "true" : "false") << std::endl;
*bool_ptr = !(*bool_ptr);
...
// Example 10: Compare different thread safety policiesvoid
