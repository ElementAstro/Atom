...
// Helper to format output for better visualizationvoid printResult(const
// std::string& operation, const String& result) {
std::cout << std::left << std::setw(30) << operation << " : \"" << result
          << "\"\n";
}

// Helper to print boolean resultsvoid printBool(const std::string& operation,
// bool result) {
std::cout << std::left << std::setw(30) << operation << " : "
          << (result ? "true" : "false") << "\n";
}

// Helper to print numeric resultstemplate <typename T>
void printValue(const std::string& operation, T value) {
    std::cout << std::left << std::setw(30) << operation << " : " << value
              << "\n";
}

// Example 1: Basic Construction and Operationsvoid basicConstructionExample() {
...
// Example 2: Basic String Methodsvoid basicStringMethodsExample() {
...
// Example 3: String Search and Manipulationvoid searchAndManipulationExample()
// {
...
for (int i = 0; i < 1000; ++i) {
    veryLongString += String("The quick brown fox jumps over the lazy dog. ");
}
...
// Example 4: String Transformationvoid transformationExample() {
...
// Compress spaces
String withExtraSpaces("This    has     multiple    spaces   between    words");
...
// Example 5: String Splitting and Joiningvoid splitAndJoinExample() {
...
// Join with separator
std::vector<String> words = {String("The"), String("quick"), String("brown"),
                             String("fox")};
...
// Example 6: String Comparison and Hashingvoid comparisonAndHashingExample() {
...
// Example 7: String Formattingvoid formattingExample() {
...
// Numeric formatting
String numFormat = String::format(
    "Integer: {:d}, Float: {:.3f}, Scientific: {:e}", 42, 3.14159, 0.0000123);
...
// Example 8: Stream Operationsvoid streamOperationsExample() {
...
// Example 10: Performance Comparisonvoid performanceExample() {
...
start = std::chrono::high_resolution_clock::now();
size_t atomReplaceCount = atomReplaceStr.replaceAll(String("x"), String("y"));
...
printValue("Speedup", static_cast<double>(normalDuration) / parallelDuration);
}
