...
// generateRandomFloatVector(usize size, f32 min_val = 0.0f,
                                           f32 max_val = 100.0f) {
                                           ...
                                           // double vectorstd::vector<f64>
                                           // generateRandomDoubleVector(usize
                                           // size, f64 min_val = 0.0,
                                            f64 max_val = 100.0) {
                                                std::random_device rd;
                                                std::mt19937 gen(rd());
                                                std::uniform_real_distribution<
                                            ...
                                            std::cout
                                                << "\nOptimal vector width for "
                                                   "f32: "
                                                << getOptimalVectorWidth<f32>()
                                                << " elements\n";
                                            std::cout
                                                << "Optimal vector width for "
                                                   "f64: "
                                                << getOptimalVectorWidth<f64>()
                                                << " elements\n";
                                            }

                                            // Demonstrate SIMD memory
                                            // operationsvoid
                                            ...
                                            std::cout << "Memset verification: "
                                                      << (set_ok ? "PASSED"
                                                                 : "FAILED")
                                                      << "\n";
                                            }

                                            // Demonstrate SIMD vector
                                            // additionvoid
                                            ...
                                            // Float vectors
                                            auto a_f32 =
                                                generateRandomFloatVector(SIZE);
                                            auto b_f32 =
                                                generateRandomFloatVector(SIZE);
                                            ...
                                            start = std::chrono::
                                                high_resolution_clock::now();
                                            MathOps::vectorAdd(
                                                a_f64.data(), b_f64.data(),
                                                result_f64.data(), SIZE);
                                            end = std::chrono::
                                                high_resolution_clock::now();
                                            ...
                                            std::cout
                                                << "f64 addition verification: "
                                                << (verify_ok ? "PASSED"
                                                              : "FAILED")
                                                << "\n";
                                            }

                                            // Demonstrate SIMD dot productvoid
                                            ...
                                            std::cout << "Vector size: " << SIZE
                                                      << ", Iterations: "
                                                      << ITERATIONS << "\n";
                                            std::cout << "SIMD total time: "
                                                      << simd_duration.count()
                                                      << " us\n";
                                            std::cout << "Scalar total time: "
                                            ...
                                            std::cout
                                                << "AVX512 f64 width: "
                                                << VectorWidth::AVX512_F64
                                                << " elements ("
                                                << VectorWidth::AVX512_F64 *
                                                       sizeof(f64) * 8
                                                << " bits)\n";
                                            std::cout << "AVX2 f32 width: "
                                                      << VectorWidth::AVX2_F32
                                                      << " elements ("
                                                      << VectorWidth::AVX2_F32 *
                                                             sizeof(f32) * 8
                                                      << " bits)\n";
                                            std::cout << "AVX2 f64 width: "
                                                      << VectorWidth::AVX2_F64
                                                      << " elements ("
                                                      << VectorWidth::AVX2_F64 *
                                                             sizeof(f64) * 8
                                                      << " bits)\n";
                                            std::cout << "SSE f32 width: "
                                                      << VectorWidth::SSE_F32
                                                      << " elements ("
                                                      << VectorWidth::SSE_F32 *
                                                             sizeof(f32) * 8
                                                      << " bits)\n";
                                            std::cout << "SSE f64 width: "
                                                      << VectorWidth::SSE_F64
                                                      << " elements ("
                                                      << VectorWidth::SSE_F64 *
                                                             sizeof(f64) * 8
                                                      << " bits)\n";
                                            std::cout << "NEON f32 width: "
                                                      << VectorWidth::NEON_F32
                                                      << " elements ("
                                                      << VectorWidth::NEON_F32 *
                                                             sizeof(f32) * 8
                                                      << " bits)\n";
                                            std::cout << "NEON f64 width: "
                                                      << VectorWidth::NEON_F64
                                                      << " elements ("
                                                      << VectorWidth::NEON_F64 *
                                                             sizeof(f64) * 8
                                                      << " bits)\n";
