/**
 * @file convolve.cpp
 * @brief Comprehensive example demonstrating convolution algorithms
 *
 * This example shows how to:
 * - Perform 1D convolution and deconvolution operations
 * - Use 2D convolution for image processing applications
 * - Apply different convolution modes (full, same, valid)
 * - Demonstrate FFT-based convolution for large signals
 * - Show performance characteristics and optimizations
...
int main() {
    std::cout << "=== Atom Convolution Algorithms Comprehensive Example ===\n";
    std::cout
        << "Demonstrating signal processing convolution capabilities...\n";

    printHeader("1D Convolution and Deconvolution");
    ...
    // Example usage of padding operations
    {
        ...
        auto [outputHeight, outputWidth] =
            getConvolutionOutputDimensions(input.size(), input[0].size(), 3, 3);
        std::cout << "Output dimensions for 3x3 kernel: " << outputHeight << "x"
                  << outputWidth << std::endl;
    }

    std::cout << "\n" << std::string(60, '=') << "\n";
    std::cout << "All Convolution Examples Completed Successfully\n";
    std::cout << std::string(60, '=') << "\n";
    std::cout << "The convolution algorithm module provides:\n";
    std::cout << "  ✓ 1D and 2D convolution operations\n";
    std::cout << "  ✓ Deconvolution for signal recovery\n";
    std::cout << "  ✓ Multiple convolution modes (full, same, valid)\n";
    std::cout << "  ✓ FFT-based convolution for large signals\n";
    std::cout << "  ✓ High-performance implementations with SIMD\n";
    std::cout << "  ✓ Support for various data types and applications\n";
