...
// Demonstrate nil UUID
void demonstrateNilUUID() {
    std::cout << "\n=== Nil UUID ===\n";
...
// Demonstrate UUID parsing from string
...
// Demonstrate UUID version detection
void demonstrateUUIDVersion() {
...
// Demonstrate UUID raw data access
void demonstrateRawDataAccess() {
...
void benchmarkUUIDGeneration() {
    ...
    std::cout << "  " << ITERATIONS << " UUIDs in " << duration.count()
              << " us\n";
