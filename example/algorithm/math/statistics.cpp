...
std::vector<f64> generateNormalData(usize size, f64 mean, f64 stddev) {
...
std::vector<f64> generateUniformData(usize size, f64 min_val, f64 max_val) {
    std::random_device rd;
    std::mt19937 gen(rd());
...
void demonstrateDescriptiveStats() {
    std::cout << "\n=== Descriptive Statistics ===\n";

    using Stats = Statistics<f64>;

    // Sample data
    std::vector<f64> data = {2.5, 3.7, 4.2, 5.1,  6.3,
                             7.8, 8.4, 9.1, 10.2, 11.5};
    ...
    std::cout << "  Std Dev (sample): " << Stats::standardDeviation(data, true)
              << "\n";
    std::cout << "  Std Dev (population): "
              << Stats::standardDeviation(data, false) << "\n";
...
void demonstrateSkewnessKurtosis() {
...
// Demonstrate correlation and covariance
void demonstrateCorrelation() {
...
// Demonstrate percentiles and quartiles
void demonstratePercentilesQuartiles() {
...
// Demonstrate range and min/max
void demonstrateRangeMinMax() {
    std::cout << "\n=== Range, Min, Max ===\n";
...
void demonstrateLargeDataset() {
    ...
    std::cout << "  Sample std dev: " << Stats::standardDeviation(data)
              << " (expected: 15)\n";
    std::cout << "  Sample median: " << Stats::median(data)
              << " (expected: ~50)\n";
