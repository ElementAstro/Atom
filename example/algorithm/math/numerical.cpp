...
// Demonstrate Newton-Raphson root findingvoid demonstrateNewtonRaphson() {
...
if (root1) {
    std::cout << "Root of x^2 - 2 = 0: " << std::fixed << std::setprecision(10)
              << *root1 << "\n";
...
// Demonstrate bisection methodvoid demonstrateBisection() {
std::cout << "\n=== Bisection Method ===\n";
...
// Demonstrate secant methodvoid demonstrateSecantMethod() {
std::cout << "\n=== Secant Method ===\n";
...
if (root) {
    std::cout << "Root of x^2 - 3 = 0: " << std::fixed << std::setprecision(10)
              << *root << "\n";
...
// Demonstrate trapezoidal rule integrationvoid demonstrateTrapezoidalRule() {
...
// Demonstrate Simpson's rule integrationvoid demonstrateSimpsonRule() {
...
// Demonstrate numerical differentiationvoid
...
// Compare root-finding methodsvoid compareRootFindingMethods() {
