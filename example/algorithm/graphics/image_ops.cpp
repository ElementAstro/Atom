...
// Helper function to print a small image as ASCIItemplate <typename T>
...
// Generate a simple test imagestd::vector<u8> generateTestImage(i32 width, i32
// height) {
...
// Generate noisy imagestd::vector<u8> generateNoisyImage(i32 width, i32 height)
// {
...
// Demonstrate convolution with custom kernelvoid demonstrateConvolution() {
std::cout << "\n=== Custom Convolution ===\n";
...
// Demonstrate Gaussian blurvoid demonstrateGaussianBlur() {
std::cout << "\n=== Gaussian Blur ===\n";
...
// Demonstrate Sobel edge detectionvoid demonstrateSobelEdgeDetection() {
...
// Demonstrate Laplacian edge detectionvoid demonstrateLaplacianEdgeDetection()
// {
...
// Demonstrate brightness adjustmentvoid demonstrateBrightnessAdjustment() {
...
// Demonstrate contrast adjustmentvoid demonstrateContrastAdjustment() {
std::cout << "\n=== Contrast Adjustment ===\n";
...
// Demonstrate histogram equalizationvoid demonstrateHistogramEqualization() {
...
// Demonstrate image thresholdingvoid demonstrateThresholding() {
std::cout << "\n=== Image Thresholding ===\n";
...
// Demonstrate image inversionvoid demonstrateInversion() {
std::cout << "\n=== Image Inversion ===\n";
...
// Benchmark image operationsvoid benchmarkImageOps() {
