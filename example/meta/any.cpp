...
// Sample struct for demonstrating complex typesstruct Person {
std::string name;
int age;
...
// Custom hash function for BoxedValuestruct BoxedValueHash {
...
// Function that transforms a BoxedValuevoid transformValue(BoxedValue& value) {
...
// Function that works with attributesvoid addMetadata(BoxedValue& value, const
// std::string& source) {
...
// Thread-safe access demonstrationvoid threadAccess(BoxedValue& shared, int id,
                      ...
                      for (int i = 0; i < 50; i++) {
                          ...
                          if (shared.hasAttr("access_count")) {
                              ...
                              if (auto countPtr = countAttr.tryCast<int>()) {
                                  shared.setAttr("access_count",
                                                 var(*countPtr + 1));
                                  results[id] = std::format(
                                      "Thread {} - access count: {}", id,
                                      *countPtr + 1);
                              }
                          }
                  ...
                  int main() {
                      std::cout << "========================================="
                                << std::endl;
                      std::cout << "    BoxedValue Comprehensive Examples    "
                                << std::endl;
                      std::cout << "========================================="
                                << std::endl;
                      ...
                      // With descriptions
                      auto namedValue =
                          varWithDesc(123.456, "Pi multiplied by 39.3");

                      // Constant values
                      auto constValue =
                          constVar(std::string("This cannot be modified"));

                      // Empty/void value
                      auto emptyValue = voidVar();

                      // Print all created values
                      std::cout << "Integer value: " << intValue.debugString()
                                << std::endl;
                      std::cout << "Double value: " << doubleValue.debugString()
                                << std::endl;
                      std::cout << "String value: " << stringValue.debugString()
                                << std::endl;
                      std::cout << "Boolean value: " << boolValue.debugString()
                                << std::endl;
                      std::cout << "Char value: " << charValue.debugString()
                                << std::endl;
                      std::cout << "Named value: " << namedValue.debugString()
                                << std::endl;
                      std::cout
                          << "Constant value: " << constValue.debugString()
                          << std::endl;
                      std::cout << "Empty value: " << emptyValue.debugString()
                                << std::endl;
                      ...
                      try {
                          ...
                          std::cout
                              << "Expected exception when modifying constant: "
                              << e.what() << std::endl;
                      }

                      // Use our transform function
                      std::cout << "\nBefore transform, intValue = "
                                << intValue.debugString() << std::endl;
                      transformValue(intValue);
                      std::cout << "After transform, intValue = "
                                << intValue.debugString() << std::endl;

                      std::cout << "Before transform, stringValue = "
                                << stringValue.debugString() << std::endl;
                      transformValue(stringValue);
                      std::cout << "After transform, stringValue = "
                                << stringValue.debugString() << std::endl;
                      ...
                      std::cout << "intValue is of type int? "
                                << (intValue.isType<int>() ? "Yes" : "No")
                                << std::endl;
                      std::cout << "doubleValue is of type double? "
                                << (doubleValue.isType<double>() ? "Yes" : "No")
                                << std::endl;
                      std::cout
                          << "stringValue is of type std::string? "
                          << (stringValue.isType<std::string>() ? "Yes" : "No")
                          << std::endl;

                      // Invalid type checks
                      std::cout
                          << "intValue is of type std::string? "
                          << (intValue.isType<std::string>() ? "Yes" : "No")
                          << std::endl;

                      // Get type info
                      std::cout << "Type of intValue: "
                                << intValue.getTypeInfo().name() << std::endl;
                      std::cout << "Type of stringValue: "
                                << stringValue.getTypeInfo().name()
                                << std::endl;

                      // Successful casting
                      if (auto intPtr = intValue.tryCast<int>()) {
                          std::cout << "Successfully cast to int: " << *intPtr
                                    << std::endl;
                      } else {
                          std::cout << "Failed to cast to int (unexpected)"
                                    << std::endl;
                      }

                      // Failed casting
                      if (auto doublePtr = stringValue.tryCast<double>()) {
                          std::cout << "Unexpectedly cast string to double: "
                                    << *doublePtr << std::endl;
                      } else {
                          std::cout
                              << "Failed to cast string to double (expected)"
                              << std::endl;
                      }

                      // Check if casting is possible
                      std::cout << "Can cast intValue to int? "
                                << (intValue.canCast<int>() ? "Yes" : "No")
                                << std::endl;
                      std::cout << "Can cast intValue to double? "
                                << (intValue.canCast<double>() ? "Yes" : "No")
                                << std::endl;
                      std::cout << "Can cast stringValue to int? "
                                << (stringValue.canCast<int>() ? "Yes" : "No")
                                << std::endl;
                      ...
                      std::cout << "intRef is a reference? "
                                << (intRef.isRef() ? "Yes" : "No") << std::endl;
                      std::cout << "stringRef is a reference? "
                                << (stringRef.isRef() ? "Yes" : "No")
                                << std::endl;
                      ...
                      std::cout
                          << "After modification, original int: " << originalInt
                          << std::endl;
                      std::cout << "After modification, original string: "
                      ...
                      if (auto ptr = intCopy.tryCast<int>()) {
                          *ptr = 200;
                          std::cout << "Modified copy to: " << *ptr
                                    << std::endl;
                      }
                      std::cout << "Original int after modifying copy: "
                                << originalInt << " (unchanged)" << std::endl;
                      ...
                      // Add attributes
                      record.setAttr("created",
                                     var(std::chrono::system_clock::now()));
                      ...
                      for (const auto& attrName : record.listAttrs()) {
                          ...
                          std::cout << " - " << attrName << ": "
                                    << attr.debugString() << std::endl;
                      }

                      // Check for attribute existence
                      std::cout << "Has 'owner' attribute? "
                                << (record.hasAttr("owner") ? "Yes" : "No")
                                << std::endl;
                      std::cout << "Has 'missing' attribute? "
                                << (record.hasAttr("missing") ? "Yes" : "No")
                                << std::endl;
                      ...
                      std::cout << "\nAfter removing 'read_only' attribute:"
                                << std::endl;
                      std::cout << "Has 'read_only' attribute? "
                                << (record.hasAttr("read_only") ? "Yes" : "No")
                                << std::endl;
                      ...
                      std::cout
                          << "Person BoxedValue: " << personValue.debugString()
                          << std::endl;

                      // Access the person object
                      if (auto personPtr = personValue.tryCast<Person>()) {
                          std::cout << "Name: " << personPtr->name
                                    << ", Age: " << personPtr->age << std::endl;
                      }

                      // Modify the original after storing in BoxedValue
                      alice.age = 29;

                      // Check if the BoxedValue reflects the change (it
                      // shouldn't, as it's a copy)
                      if (auto personPtr = personValue.tryCast<Person>()) {
                          std::cout << "After modifying original - Name: "
                                    << personPtr->name
                                    << ", Age: " << personPtr->age
                                    << " (should still be 28)" << std::endl;
                      }
                      ...
                      std::cout << "Original person after modifying through "
                                   "reference - "
                                << "Name: " << alice.name
                                << ", Age: " << alice.age << std::endl;
                      ...
                      std::cout
                          << "Vector BoxedValue: " << vectorValue.debugString()
                          << std::endl;
                      ...
                      std::cout
                          << "Starting 5 threads to access shared value..."
                          << std::endl;

                      for (int i = 0; i < 5; i++) {
                          threads.emplace_back(threadAccess,
                                               std::ref(sharedValue), i,
                                               std::ref(results));
                      }
                      ...
                      if (auto countAttr = sharedValue.getAttr("access_count");
                          ...
                          std::cout << "Final access count: " << *countPtr
                                    << std::endl;
                      }
                      ...
                      std::unordered_map<BoxedValue, std::string,
                                         BoxedValueHash>
                          valueMap;
                      ...
                      // Look up values
                      std::cout << "Map lookup for 1: " << valueMap[var(1)]
                                << std::endl;
                      std::cout << "Map lookup for 2: " << valueMap[var(2)]
                                << std::endl;
                      std::cout << "Map lookup for \"three\": "
                                << valueMap[var("three")] << std::endl;
                      std::cout
                          << "Map lookup for true: " << valueMap[var(true)]
                          << std::endl;
                      std::cout
                          << "Map lookup for Person: " << valueMap[var(bob)]
                          << std::endl;
                      ...
                      BoxedValue nullValue;  // Default constructor creates a
                                             // null value
                      auto undefValue = voidVar();  // Create an undefined value

                      std::cout << "nullValue is null? "
                                << (nullValue.isNull() ? "Yes" : "No")
                                << std::endl;
                      std::cout << "undefValue is undefined? "
                                << (undefValue.isUndef() ? "Yes" : "No")
                                << std::endl;
                      std::cout << "emptyValue is void? "
                                << (emptyValue.isVoid() ? "Yes" : "No")
                                << std::endl;

                      // Return value flag
                      auto returnVal = makeBoxedValue(
                          42, true, false);  // Create with returnValue flag
                      std::cout << "returnVal is return value? "
                                << (returnVal.isReturnValue() ? "Yes" : "No")
                                << std::endl;
                      ...
                      try {
                          std::cout << "Value: " << nullValue.debugString()
                                    << std::endl;
                      } catch (const std::exception& e) {
                          std::cout << "Expected exception when accessing null "
                                       "value: "
                                    << e.what() << std::endl;
                      }
                      ...
                      try {
                          ...
                          std::cout << "Expected exception setting attribute "
                                       "on null value: "
                                    << e.what() << std::endl;
                      }
                      ...
                      auto smallString =
                          var(std::string("Small"));  // Should use small buffer
                      ...
                      std::cout << "Created various sized objects to "
                                   "demonstrate small buffer "
                                   "optimization"
                                << std::endl;
                      std::cout << "Small int: " << smallInt.debugString()
                                << std::endl;
                      std::cout << "Small string: " << smallString.debugString()
                                << std::endl;
                      std::cout << "Large vector size: " << largeVector.size()
                                << std::endl;
                      std::cout << "Large string size: " << largeString.size()
                                << std::endl;
