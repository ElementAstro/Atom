...
int main() {
    ...
    std::vector<ImageMetadata> image_collection = {
        {"M31_L_001.fits", "M31 Andromeda Galaxy", "Luminance", 300.0, 800,
         -10.0, "2024-10-03T22:30:00", 10.6847, 41.2687, "EdgeHD 11",
         "ASI2600MM", 6248, 4176, 16, 1.15, 2.1, "Raw"},
        {"M31_L_002.fits", "M31 Andromeda Galaxy", "Luminance", 300.0, 800,
         -10.2, "2024-10-03T22:35:00", 10.6847, 41.2687, "EdgeHD 11",
         "ASI2600MM", 6248, 4176, 16, 1.18, 2.3, "Raw"},
        {"M31_L_003.fits", "M31 Andromeda Galaxy", "Luminance", 300.0, 800,
         -10.1, "2024-10-03T22:40:00", 10.6847, 41.2687, "EdgeHD 11",
         "ASI2600MM", 6248, 4176, 16, 1.22, 2.0, "Raw"},
        {"M31_R_001.fits", "M31 Andromeda Galaxy", "Red", 240.0, 800, -9.8,
         "2024-10-03T23:00:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.35, 2.4, "Raw"},
        {"M31_R_002.fits", "M31 Andromeda Galaxy", "Red", 240.0, 800, -9.9,
         "2024-10-03T23:05:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.38, 2.2, "Raw"},
        {"M31_G_001.fits", "M31 Andromeda Galaxy", "Green", 240.0, 800, -10.0,
         "2024-10-03T23:30:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.45, 2.5, "Raw"},
        {"M31_G_002.fits", "M31 Andromeda Galaxy", "Green", 240.0, 800, -10.1,
         "2024-10-03T23:35:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.48, 2.3, "Raw"},
        {"M31_B_001.fits", "M31 Andromeda Galaxy", "Blue", 300.0, 800, -10.2,
         "2024-10-04T00:00:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.52, 2.8, "Raw"},
        {"M31_B_002.fits", "M31 Andromeda Galaxy", "Blue", 300.0, 800, -10.0,
         "2024-10-04T00:05:00", 10.6847, 41.2687, "EdgeHD 11", "ASI2600MM",
         6248, 4176, 16, 1.55, 2.6, "Raw"},
        {"NGC7000_Ha_001.fits", "NGC 7000 North America Nebula", "H-alpha",
         600.0, 800, -12.0, "2024-10-04T01:00:00", 312.25, 44.22, "EdgeHD 11",
         "ASI2600MM", 6248, 4176, 16, 1.25, 1.8, "Raw"}};

    std::cout << "1. Batch metadata loading:\n";
    std::cout << "   Loaded " << image_collection.size()
    ...
    for (const auto& [filter, images] : filters) {
        ...
        std::cout << "   - " << filter << ": " << images.size() << " images, "
                  << total_exposure << "s total exposure\n";
    }
    ...
    for (size_t i = 0; i < std::min(size_t(3), sorted_by_seeing.size()); ++i) {
        ...
        std::cout << "   - " << img->filename << ": " << img->seeing
                  << " arcsec\n";
    }
    ...
    std::cout << "   Selected for processing: " << processed_count
              << " images\n";
    std::cout << "   Rejected: " << (image_collection.size() - processed_count)
              << " images\n";
    ...
    for (const auto& img : image_collection) {
        if (img.telescope != reference_telescope) {
            std::cout << "   ⚠ Telescope mismatch in " << img.filename
                      << std::endl;
            validation_passed = false;
        }
        if (img.camera != reference_camera) {
            std::cout << "   ⚠ Camera mismatch in " << img.filename
                      << std::endl;
            validation_passed = false;
        }
        if (img.width != image_collection[0].width ||
            img.height != image_collection[0].height) {
            std::cout << "   ⚠ Resolution mismatch in " << img.filename
                      << std::endl;
            validation_passed = false;
        }
    }
    ...
    if (validation_passed) {
        std::cout
            << "   ✓ All images have consistent equipment and resolution\n";
    }
    ...
    std::cout << "     Columns: filename, object, filter, exposure, iso, "
                 "seeing, airmass\n";
