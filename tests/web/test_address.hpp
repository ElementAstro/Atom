...
TEST_F(IPv4Test, StaticValidation) {
    EXPECT_TRUE(IPv4::isValidIPv4("192.168.1.1"));
    EXPECT_TRUE(IPv4::isValidIPv4("0.0.0.0"));
    EXPECT_TRUE(IPv4::isValidIPv4("255.255.255.255"));

    EXPECT_FALSE(IPv4::isValidIPv4("256.1.1.1"));
    EXPECT_FALSE(IPv4::isValidIPv4("192.168.1"));
    EXPECT_FALSE(IPv4::isValidIPv4("not.an.ip"));
    EXPECT_FALSE(IPv4::isValidIPv4(""));
}
