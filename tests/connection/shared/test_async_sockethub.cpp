...
TEST_F(AsyncSocketHubTest, MessageHandling) {
    ...
    EXPECT_EQ(receivedMessage.asString(), testMessage);
}
...
TEST_F(AsyncSocketHubTest, BroadcastMessage) {
    ...
    // Broadcast a message
    Message broadcastMsg = Message::createText("Broadcast test message");
...
TEST_F(AsyncSocketHubTest, SendMessageToSpecificClient) {
    ...
    Message specificMsg = Message::createText("Specific client message");
...
TEST_F(AsyncSocketHubTest, GroupManagement) {
    ...
    // Broadcast to group1
    Message groupMsg = Message::createText("Group1 message");
...
TEST_F(AsyncSocketHubTest, ErrorHandling) {
    ...
    Message msg = Message::createText("Error test");
