...
REM This script has been moved to scripts/build.bat
...
set ACTUAL_SCRIPT=%SCRIPT_DIR%scripts\build.bat

if not exist "%ACTUAL_SCRIPT%" (
    echo Error: Build script not found at %ACTUAL_SCRIPT%
    echo Please ensure the scripts directory contains build.bat
    exit /b 1
)
