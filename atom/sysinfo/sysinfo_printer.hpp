 ...
 *
 * This file contains definitions for classes and functions that format system
 * information into human-readable text and reports. It provides utilities for
 * generating formatted system information displays and exporting them to
 ...
 *
 * This class provides static methods to format different types of system
 * information into readable text, generate comprehensive system reports, and
 * export this information to various file formats like HTML, JSON, and
 * Markdown.
 */
class SystemInfoPrinter {
public:
