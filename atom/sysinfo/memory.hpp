/**
 * @file memory.hpp
 * @brief System memory information functionality (compatibility header)
 *
 * This file serves as a compatibility header that includes the reorganized
 * memory system. It maintains backward compatibility with existing code that
 * includes this header.
 *
 * @deprecated This header location is deprecated. Please use
 * "atom/sysinfo/interfaces/memory.hpp" instead.
