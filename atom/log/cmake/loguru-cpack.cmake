...
# NOTE: cpack assumes by default that it's being called from a top-level
# project. It uses the top-level project values to generate 'CPackConfig.cmake'
# and tries to place it into the top-level build directory. This behavior makes
# sense if you're writing a standalone cmake project, but causes grief if your
# project is designed to be included as a sub-project e.g. using
# add_subdirectory()   or   FetchContent() Here, we trick cpack into using the
# current current project info instead.
