 ...
 * @brief Backwards compatibility header for clipboard errors.
 *
 * @deprecated This header location is deprecated. Please use
 * "atom/system/clipboard/clipboard_error.hpp" instead.
 */
...
#include "clipboard/clipboard_error.hpp"

< < < < < < < < HEAD : atom / system / clipboard /
                       clipboard_error.hpp
    ...
    public:
        ...
        explicit ClipboardException(ClipboardErrorCode code,
            ...
            : std::runtime_error(std::format(
                  "{}: {}", make_error_code(code).message(), message)),
              error_code_(make_error_code(code)) {}
...
== == == ==
    ...
    >>>>>>>> test - fixes / systematic -
                 testing : atom / system / clipboard_error.hpp
