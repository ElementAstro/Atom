...
private:
    ...
    static void copySSE2(void* dest, const void* src, usize size) noexcept {
        ...
        for (usize i = 0; i < simd_size; i += 16) {
            __m128i data = _mm_load_si128(reinterpret_cast<const __m128i*>(s + i));
...
public:
     ...
     */
    template <typename T>
    static void vectorAdd(const T* a, const T* b, T* result, usize size) noexcept {
...
private:
    template <typename T>
    static void vectorAddScalar(const T* a, const T* b, T* result, usize size) noexcept {
...
#ifdef ATOM_SIMD_AVX2
    static void vectorAddAVX2(const f32* a, const f32* b, f32* result, usize size) noexcept {
    ...
    static void vectorAddAVX2_f64(const f64* a, const f64* b, f64* result, usize size) noexcept {
    ...
    static f64 dotProductAVX2_f64(const f64* a, const f64* b, usize size) noexcept {
...
#ifdef ATOM_SIMD_SSE2
    static void vectorAddSSE2(const f32* a, const f32* b, f32* result, usize size) noexcept {
        usize simd_size = size - (size % 4);
        for (usize i = 0; i < simd_size; i += 4) {
    ...
    static void vectorAddSSE2_f64(const f64* a, const f64* b, f64* result, usize size) noexcept {
    ...
    static f64 dotProductSSE2_f64(const f64* a, const f64* b, usize size) noexcept {
    ...
    static void vectorAddNEON(const f32* a, const f32* b, f32* result, usize size) noexcept {
        usize simd_size = size - (size % 4);
        for (usize i = 0; i < simd_size; i += 4) {
