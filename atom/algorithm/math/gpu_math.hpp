...
public:
     ...
     */
    [[nodiscard]] auto vectorAdd(const std::vector<f32>& a, const std::vector<f32>& b) -> std::vector<f32>;
     ...
     */
    [[nodiscard]] auto vectorMultiply(const std::vector<f32>& a, const std::vector<f32>& b) -> std::vector<f32>;
     ...
     */
    [[nodiscard]] auto dotProduct(const std::vector<f32>& a, const std::vector<f32>& b) -> f32;
     ...
     */
    [[nodiscard]] auto matrixMultiply(const std::vector<f32>& a, const std::vector<f32>& b,
                                     usize rows_a, usize cols_a, usize cols_b) -> std::vector<f32>;
     ...
     */
    [[nodiscard]] auto matrixTranspose(const std::vector<f32>& matrix, usize rows, usize cols) -> std::vector<f32>;
     ...
     */
    [[nodiscard]] auto calculateVariance(const std::vector<f32>& data, f32 mean = 0.0f) -> f32;
...
private:
    ...
    // Helper methods
    [[nodiscard]] auto executeVectorOperation(const std::string& kernel_source,
    ...
    // Get kernel source strings
    [[nodiscard]] static auto getVectorAddKernel() -> const std::string&;
    [[nodiscard]] static auto getVectorMultiplyKernel() -> const std::string&;
    [[nodiscard]] static auto getDotProductKernel() -> const std::string&;
    [[nodiscard]] static auto getMatrixMultiplyKernel() -> const std::string&;
    [[nodiscard]] static auto getMatrixTransposeKernel() -> const std::string&;
    [[nodiscard]] static auto getPrimeSieveKernel() -> const std::string&;
    [[nodiscard]] static auto getReductionKernel() -> const std::string&;
    [[nodiscard]] static auto getVarianceKernel() -> const std::string&;
