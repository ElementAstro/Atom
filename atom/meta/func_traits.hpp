 ...
 * OPTIMIZED VERSION \author Max Qian <lightapt.com> \date 2024-04-02 \optimized
...
struct FunctionTraitsBase {
    ...
    template <typename T>
    static constexpr std::size_t count_argument =
    ...
    static constexpr bool all_nothrow_constructible =
