...
Description: Specific error code enumerations for different domains

**************************************************/

#ifndef ATOM_ERROR_CORE_ERROR_CODES_HPP
#define ATOM_ERROR_CORE_ERROR_CODES_HPP
...
#endif  // ATOM_ERROR_CORE_ERROR_CODES_HPP
