#ifndef ATOM_ASYNC_CORE_PROMISE_HPP
#define ATOM_ASYNC_CORE_PROMISE_HPP
...
public:
    ...
    PromiseCancelledException& operator=(const PromiseCancelledException&) =
        default;
...
#endif  // ATOM_ASYNC_CORE_PROMISE_HPP
