...
#ifndef ATOM_ASYNC_THREADING_THREAD_WRAPPER_HPP
#define ATOM_ASYNC_THREADING_THREAD_WRAPPER_HPP
...
public:
    ...
    template <typename Callable, typename... Args>
        requires(ThreadCallable<Callable, Args...> ||
                 StopTokenCallable<Callable, Args...>)
...
#endif  // ATOM_ASYNC_THREADING_THREAD_WRAPPER_HPP
