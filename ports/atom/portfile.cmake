# vcpkg portfile for Atom library This file defines how to build and install the
# Atom library using vcpkg
...
vcpkg_from_github(
  ...
  v${VERSION}
  SHA512
  0 # This will be automatically updated by vcpkg
  HEAD_REF
  main
  PATCHES
...
# Core build options
list(APPEND ATOM_BUILD_OPTIONS -DATOM_BUILD_EXAMPLES=OFF -DATOM_BUILD_TESTS=OFF
     -DATOM_BUILD_DOCS=OFF -DATOM_BUILD_PYTHON_BINDINGS=OFF)
...
vcpkg_cmake_config_fixup(PACKAGE_NAME atom CONFIG_PATH lib/cmake/atom)
...
file(GLOB ATOM_LIBRARIES "${CURRENT_PACKAGES_DIR}/lib/libatom*.a"
