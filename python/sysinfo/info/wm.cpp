...
Examples:
    ...
    >>> print(f"Theme: {sys_info.theme}")
        ...
        .def_readwrite("desktop_environment", &SystemInfo::desktopEnvironment,
                       "Name of the desktop environment (e.g., 'GNOME', 'KDE', "
                       "'XFCE', 'Windows Explorer')")
        .def_readwrite(
            "window_manager", &SystemInfo::windowManager,
            "Name of the window manager (e.g., 'Mutter', 'KWin', 'DWM')")
        .def_readwrite(
            "display_server", &SystemInfo::displayServer,
        ...
        .def_readwrite("theme", &SystemInfo::theme, "Current system theme name")
        ...
        .def_readwrite("accessibility_enabled",
                       &SystemInfo::accessibilityEnabled,
        ...
        .def_readwrite("virtual_desktops_count",
                       &SystemInfo::virtualDesktopsCount,
        ...
        .def_readwrite("power_management_enabled",
                       &SystemInfo::powerManagementEnabled,
...
Examples:
    ...
    m.def(
        "get_display_server", []() { return getSystemInfo().displayServer; },
...
Examples:
    ...
    m.def(
        "get_session_type", []() { return getSystemInfo().sessionType; },
...
Examples:
    ...
    m.def(
        "get_current_theme", []() { return getSystemInfo().theme; },
...
Examples:
    ...
    m.def(
        "get_scaling_factor", []() { return getSystemInfo().scalingFactor; },
