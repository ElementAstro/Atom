...
PYBIND11_MODULE(conversion, m) {
    m.doc() =
        "Type conversion and serialization utilities module for the atom "
        "package";
    ...
    // Exception classes
    py::register_exception<atom::utils::ParserException>(
        m, "ParserException",
    ...
    py::register_exception<atom::utils::SerializationException>(
        m, "SerializationException",
    ...
    py::class_<atom::utils::Parser>(
        ...
        .def(
            "parse_literal",
            [](atom::utils::Parser& self,
               const std::string& input) -> py::object {
        ...
        .def(
            "parse_literal_with_default",
            [](atom::utils::Parser& self, const std::string& input,
    ...
    // File I/O functions
    m.def("save_to_file", &atom::utils::saveToFile, py::arg("data"),
          py::arg("filename"),
    ...
    m.def("load_from_file", &atom::utils::loadFromFile, py::arg("filename"),
