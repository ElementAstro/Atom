...
Examples:
    ...
    >>> dt_str = dt.to_string("%Y-%m-%d")
        ...
        .def(py::init<const std::string&, const std::string&, const atom::utils::QTimeZone&>(),
             py::arg("date_time_string"), py::arg("format"), py::arg("time_zone"),
             "Constructs a DateTime object from a date-time string, format, and time zone.")
        .def_static("current_date_time", &atom::utils::QDateTime::currentDateTime,
             "Returns the current date and time.")
        .def_static("current_date_time", py::overload_cast<const atom::utils::QTimeZone&>(&atom::utils::QDateTime::currentDateTime),
             py::arg("time_zone"),
             "Returns the current date and time in the specified time zone.")
        .def_static("from_string", 
             py::overload_cast<const std::string&, const std::string&>(&atom::utils::QDateTime::fromString<const std::string&, const std::string&>),
             py::arg("date_time_string"), py::arg("format"),
             "Constructs a DateTime object from a date-time string and format.")
        .def_static("from_string",
             py::overload_cast<const std::string&, const std::string&, const atom::utils::QTimeZone&>(
                &atom::utils::QDateTime::fromString<const std::string&, const std::string&>),
             py::arg("date_time_string"), py::arg("format"), py::arg("time_zone"),
             "Constructs a DateTime object from a date-time string, format, and time zone.")
        .def("to_string",
             py::overload_cast<const std::string&>(&atom::utils::QDateTime::toString<const std::string&>),
             py::arg("format"),
             "Converts the DateTime object to a string in the specified format.")
        .def("to_string",
             py::overload_cast<const std::string&, const atom::utils::QTimeZone&>(
                &atom::utils::QDateTime::toString<const std::string&>),
             py::arg("format"), py::arg("time_zone"),
             "Converts the DateTime object to a string in the specified format and time zone.")
        ...
        .def("days_to", &atom::utils::QDateTime::daysTo, py::arg("other"),
             "Computes the number of days between this DateTime object and another.")
        .def("secs_to", &atom::utils::QDateTime::secsTo, py::arg("other"),
             "Computes the number of seconds between this DateTime object and another.")
        ...
        .def("add_months", &atom::utils::QDateTime::addMonths, py::arg("months"),
        ...
        .def("set_date", &atom::utils::QDateTime::setDate, py::arg("year"), py::arg("month"), py::arg("day"),
             "Sets the date part of the DateTime object.")
        .def("set_time", &atom::utils::QDateTime::setTime, py::arg("hour"), py::arg("minute"), py::arg("second"), py::arg("ms") = 0,
             "Sets the time part of the DateTime object.")
        .def("set_time_zone", &atom::utils::QDateTime::setTimeZone, py::arg("time_zone"),
        ...
        .def("__dir__", [](const atom::utils::QDateTime&) {
            return std::vector<std::string>{
                "add_days", "add_msecs", "add_months", "add_secs", "add_years",
                "days_to", "get_date", "get_time", "is_dst", "is_valid", "secs_to",
                "set_date", "set_time", "set_time_zone", "time_zone", "to_local_time",
