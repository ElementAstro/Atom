...
PYBIND11_MODULE(container, m) {
    ...
    m.def("is_subset", 
          [](const std::vector<int>& subset, const std::vector<int>& superset) -> bool {
    ...
    m.def("is_subset_str", 
          [](const std::vector<std::string>& subset, const std::vector<std::string>& superset) -> bool {
              return atom::utils::isSubset(subset, superset);
          },
          py::arg("subset"), py::arg("superset"),
    ...
    m.def("contains_str", 
          [](const std::vector<std::string>& container, const std::string& value) -> bool {
              return atom::utils::contains(container, value);
          },
          py::arg("container"), py::arg("value"),
    ...
    m.def("intersection", 
          [](const std::vector<int>& container1, const std::vector<int>& container2) -> std::vector<int> {
    ...
    m.def("intersection_str", 
          [](const std::vector<std::string>& container1, const std::vector<std::string>& container2) -> std::vector<std::string> {
              auto result = atom::utils::intersection(container1, container2);
    ...
    m.def("slice", 
          [](const std::vector<int>& container, size_t start, size_t end) -> std::vector<int> {
    ...
    m.def("slice_str", 
          [](const std::vector<std::string>& container, size_t start, size_t end) -> std::vector<std::string> {
              return atom::utils::slice(container, start, end);
          },
          py::arg("container"), py::arg("start"), py::arg("end"),
    ...
    m.def("filter_span", 
          [](const std::vector<int>& data, py::function predicate) -> std::vector<int> {
              std::span<const int> span_data(data);
    ...
    m.def("unique_str", 
          [](const std::vector<std::string>& container) -> std::vector<std::string> {
              auto hash_set = atom::utils::toHashSet(container);
