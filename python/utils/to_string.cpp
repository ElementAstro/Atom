...
PYBIND11_MODULE(to_string, m) {
    m.doc() = "Object to string conversion utilities module for the atom package";
    ...
    py::register_exception<atom::utils::ToStringException>(m, "ToStringException",
    ...
    m.def("to_string_list", 
          [](const std::vector<std::string>& container, const std::string& separator = ", ") -> std::string {
    ...
    m.def("to_string_int_list", 
          [](const std::vector<int>& container, const std::string& separator = ", ") -> std::string {
              return atom::utils::toString(container, separator);
          },
          py::arg("container"), py::arg("separator") = ", ",
    ...
    m.def("to_string_float_list", 
          [](const std::vector<double>& container, const std::string& separator = ", ") -> std::string {
              return atom::utils::toString(container, separator);
          },
          py::arg("container"), py::arg("separator") = ", ",
    ...
    m.def("to_string_dict", 
          [](const std::map<std::string, std::string>& container, const std::string& separator = ", ") -> std::string {
              return atom::utils::toString(container, separator);
          },
          py::arg("container"), py::arg("separator") = ", ",
    ...
    m.def("to_string_array", 
          [](const std::vector<std::string>& array, const std::string& separator = " ") -> std::string {
    ...
    m.def("to_string_range", 
          [](const std::vector<int>& container, const std::string& separator = ", ") -> std::string {
              return atom::utils::toStringRange(container.begin(), container.end(), separator);
          },
          py::arg("container"), py::arg("separator") = ", ",
          ...
          [](py::object obj) -> std::string {
              try {
                  ...
                  throw atom::utils::ToStringException(
                      std::string("Python object conversion failed: ") + e.what());
              }
          },
          py::arg("obj"),
