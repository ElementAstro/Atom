...
PYBIND11_MODULE(switch, m) {
    m.doc() =
        "String-based switch statement utilities module for the atom package";
    ...
    py::class_<atom::utils::StringSwitch<>::Stats::Snapshot>(
        m, "StatsSnapshot",
        ...
        .def_readonly("total_calls",
                      &atom::utils::StringSwitch<>::Stats::Snapshot::totalCalls,
                      "Total number of match calls made")
        .def_readonly("cache_hits",
                      &atom::utils::StringSwitch<>::Stats::Snapshot::cacheHits,
                      "Number of cache hits")
        .def_readonly(
            "cache_misses",
            &atom::utils::StringSwitch<>::Stats::Snapshot::cacheMisses,
            "Number of cache misses")
        .def_readonly("hit_ratio",
                      &atom::utils::StringSwitch<>::Stats::Snapshot::hitRatio,
                      "Cache hit ratio (0.0 to 1.0)")
        .def_readonly(
            "avg_response_time",
            &atom::utils::StringSwitch<>::Stats::Snapshot::avgResponseTime,
            "Average response time in seconds")
        .def_readonly("error_count",
                      &atom::utils::StringSwitch<>::Stats::Snapshot::errorCount,
                      "Number of errors encountered")
        .def_readonly("total_cases",
                      &atom::utils::StringSwitch<>::Stats::Snapshot::totalCases,
                      "Total number of registered cases");

    // StringSwitch class for Python functions (non-thread-safe version)
    py::class_<atom::utils::StringSwitch<false>>(
        m, "StringSwitch",
        ...
        .def(
            "register_case",
            [](atom::utils::StringSwitch<false>& self, const std::string& key,
               py::function func) {
                self.registerCase(
                    key,
                    [func]() -> atom::utils::StringSwitch<false>::ReturnType {
                        try {
                            auto result = func();
                            if (py::isinstance<py::str>(result)) {
                                return atom::utils::String(
                            ...
                            throw std::runtime_error(
                                std::string("Function execution failed: ") +
                                e.what());
                        }
                    });
            },
        ...
        .def("unregister_case",
             &atom::utils::StringSwitch<false>::unregisterCase<
                 const std::string&>,
             py::arg("key"),
        ...
        .def(
            "match",
            [](atom::utils::StringSwitch<false>& self,
                ...
                self.setDefault(
                    [func]() -> atom::utils::StringSwitch<false>::ReturnType {
                        try {
                            ...
                            throw std::runtime_error(
                                std::string(
                                    "Default function execution failed: ") +
                                e.what());
                        }
                    });
            },
        ...
        .def("has_case",
             &atom::utils::StringSwitch<false>::hasCase<const std::string&>,
             py::arg("key"),
