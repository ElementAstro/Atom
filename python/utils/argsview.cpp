...
PYBIND11_MODULE(argsview, m) {
    m.doc() =
        "Command-line argument parsing utilities module for the atom package";
    ...
    // ArgType enumeration
    py::enum_<atom::utils::ArgumentParser::ArgType>(
        m, "ArgType",
    ...
    py::enum_<atom::utils::ArgumentParser::NargsType>(
        m, "NargsType",
    ...
    // Nargs structure
    py::class_<atom::utils::ArgumentParser::Nargs>(
        m, "Nargs",
    ...
    py::class_<atom::utils::ArgumentParser>(
        m, "ArgumentParser",
        ...
        .def(
            "parse",
            [](atom::utils::ArgumentParser& self,
               const std::vector<std::string>& args) {
                ...
                self.parse(static_cast<int>(atom_args.size()),
                           std::span<const atom::utils::String>(atom_args));
            },
            py::arg("args"),
        ...
        .def(
            "get_string",
            [](const atom::utils::ArgumentParser& self,
        ...
        .def("get_flag", &atom::utils::ArgumentParser::getFlag, py::arg("name"),
