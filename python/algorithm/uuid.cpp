...
PYBIND11_MODULE(uuid, m) {
    ...
    py::class_<atom::algorithm::UUID>(m, "UUID", R"pbdoc(
        ...
        .def_static(
            "generate_time_based",
            [](const std::array<uint8_t, 6>& node_id) {
        ...
        .def_static("generate_name_based_md5",
                    &atom::algorithm::UUID::generateNameBasedMD5,
        ...
        .def_static("generate_name_based_sha1",
                    &atom::algorithm::UUID::generateNameBasedSHA1,
                    py::arg("namespace_uuid"), py::arg("name"),
                    R"pbdoc(
        ...
        .def_static("generate_random_node_id",
                    &atom::algorithm::UUID::generateRandomNodeId,
                    R"pbdoc(
        ...
        .def(
            "to_string",
            [](const atom::algorithm::UUID& self, bool with_hyphens) {
        ...
        .def(
            "__eq__",
            [](const atom::algorithm::UUID& self,
               const atom::algorithm::UUID& other) { return self == other; },
            "Equality comparison")
        ...
        .def(
            "__str__",
            [](const atom::algorithm::UUID& self) { return self.toString(); },
        ...
        .def(
            "__hash__",
            [](const atom::algorithm::UUID& self) { return self.hash(); },
    ...
    m.attr("NAMESPACE_DNS") = atom::algorithm::UUID::fromString(
        "6ba7b810-9dad-11d1-80b4-00c04fd430c8");
    m.attr("NAMESPACE_URL") = atom::algorithm::UUID::fromString(
        "6ba7b811-9dad-11d1-80b4-00c04fd430c8");
    m.attr("NAMESPACE_OID") = atom::algorithm::UUID::fromString(
        "6ba7b812-9dad-11d1-80b4-00c04fd430c8");
    m.attr("NAMESPACE_X500") = atom::algorithm::UUID::fromString(
...
PYBIND11_MODULE(error_calibration, m) {
    ...
    py::class_<atom::algorithm::LinearCalibration<double>>(
        m, "LinearCalibration", R"pbdoc(
        ...
        .def(
            "calibrate",
            [](atom::algorithm::LinearCalibration<double>& self,
        ...
        .def("get_intercept",
             &atom::algorithm::LinearCalibration<double>::getIntercept,
             "Get the calibration intercept parameter.")

        .def(
            "get_r_squared",
            [](const atom::algorithm::LinearCalibration<double>& self) {
        ...
        .def(
            "get_residuals",
            &atom::algorithm::LinearCalibration<double>::getResiduals,
            "Get the residuals (differences between fitted and actual values).")

        .def("print_parameters",
             &atom::algorithm::LinearCalibration<double>::printParameters,
             "Print calibration parameters and metrics to console.");

    // Polynomial Calibration class
    py::class_<atom::algorithm::PolynomialCalibration<double>>(
        m, "PolynomialCalibration", R"pbdoc(
        Polynomial calibration for non-linear relationships.
        ...
        .def(
            "calibrate",
            [](atom::algorithm::PolynomialCalibration<double>& self,
               const std::vector<double>& measured,
               const std::vector<double>& actual) {
                self.calibrate(measured, actual);
            },
        ...
        .def("get_coefficients",
             &atom::algorithm::PolynomialCalibration<double>::getCoefficients,
             "Get the polynomial coefficients.")

        .def("get_degree",
             &atom::algorithm::PolynomialCalibration<double>::getDegree,
             "Get the polynomial degree.")

        .def(
            "get_r_squared",
            [](const atom::algorithm::PolynomialCalibration<double>& self) {
                auto r_sq = self.getRSquared();
                return r_sq.has_value() ? r_sq.value() : py::none();
            },
        ...
        .def("get_residuals",
             &atom::algorithm::PolynomialCalibration<double>::getResiduals,
             "Get the residuals.")

        .def("print_parameters",
             &atom::algorithm::PolynomialCalibration<double>::printParameters,
             "Print calibration parameters and metrics.");

    // Power Law Calibration class
    py::class_<atom::algorithm::PowerLawCalibration<double>>(
        m, "PowerLawCalibration", R"pbdoc(
        Power law calibration for exponential relationships.
        ...
        .def(
            "calibrate",
            [](atom::algorithm::PowerLawCalibration<double>& self,
               const std::vector<double>& measured,
               const std::vector<double>& actual) {
                self.calibrate(measured, actual);
            },
        ...
        .def("get_residuals",
             &atom::algorithm::PowerLawCalibration<double>::getResiduals,
             "Get the residuals.")

        .def("print_parameters",
             &atom::algorithm::PowerLawCalibration<double>::printParameters,
             "Print calibration parameters and metrics.");
}
