...
PYBIND11_MODULE(gpu_math, m) {
    ...
    py::class_<atom::algorithm::gpu::GPUMath>(m, "GPUMath", R"pbdoc(
        ...
        .def("initialize", &atom::algorithm::gpu::GPUMath::initialize,
        ...
        .def("vector_add", [](atom::algorithm::gpu::GPUMath& self, 
                             const std::vector<float>& a, 
                             const std::vector<float>& b) {
            return self.vectorAdd(a, b);
        }, py::arg("a"), py::arg("b"),
        R"pbdoc(
        ...
        .def("vector_multiply", [](atom::algorithm::gpu::GPUMath& self,
                                  const std::vector<float>& a,
                                  const std::vector<float>& b) {
        ...
        .def("dot_product", [](atom::algorithm::gpu::GPUMath& self,
                              const std::vector<float>& a,
                              const std::vector<float>& b) {
        ...
        .def("matrix_multiply", [](atom::algorithm::gpu::GPUMath& self,
                                  const std::vector<float>& a,
                                  const std::vector<float>& b,
        ...
        .def("matrix_transpose", [](atom::algorithm::gpu::GPUMath& self,
        ...
        .def("generate_primes", [](atom::algorithm::gpu::GPUMath& self, uint32_t limit) {
        ...
        .def("calculate_mean", [](atom::algorithm::gpu::GPUMath& self,
        ...
        .def("calculate_variance", [](atom::algorithm::gpu::GPUMath& self,
                                     const std::vector<float>& data) {
    ...
    py::class_<atom::algorithm::simd::SIMDCapabilities>(m, "SIMDCapabilities", R"pbdoc(
        ...
        .def_static("has_sse2", &atom::algorithm::simd::SIMDCapabilities::hasSSE2,
                   "Check if SSE2 instructions are available.")
        .def_static("has_avx2", &atom::algorithm::simd::SIMDCapabilities::hasAVX2,
                   "Check if AVX2 instructions are available.")
        .def_static("has_avx512", &atom::algorithm::simd::SIMDCapabilities::hasAVX512,
                   "Check if AVX-512 instructions are available.")
        .def_static("has_neon", &atom::algorithm::simd::SIMDCapabilities::hasNEON,
    ...
    py::class_<atom::algorithm::simd::MemoryOps>(m, "SIMDMemoryOps", R"pbdoc(
        ...
        .def_static("copy", [](py::array_t<uint8_t> dest, py::array_t<uint8_t> src) {
