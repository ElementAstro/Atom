...
PYBIND11_MODULE(bignumber, m) {
    ...
    py::class_<atom::algorithm::BigNumber>(m, "BigNumber",
        ...
        // Constructors
        .def(py::init<>(), 
             "Constructs a BigNumber with value 0.")
        ...
        .def("subtract", &atom::algorithm::BigNumber::subtract, py::arg("other"),
             R"pbdoc(
        ...
        .def("multiply", &atom::algorithm::BigNumber::multiply, py::arg("other"),
             R"pbdoc(
        ...
        .def("set_string", &atom::algorithm::BigNumber::setString, py::arg("new_str"),
             R"pbdoc(
        ...
        .def("trim_leading_zeros", &atom::algorithm::BigNumber::trimLeadingZeros,
             R"pbdoc(
        ...
        .def("equals", static_cast<bool (atom::algorithm::BigNumber::*)(const atom::algorithm::BigNumber&) const>(&atom::algorithm::BigNumber::equals),
             py::arg("other"),
             R"pbdoc(
        ...
        .def("__repr__", [](const atom::algorithm::BigNumber& bn) {
        ...
        .def("__bool__", [](const atom::algorithm::BigNumber& bn) {
        ...
        .def("__iadd__", [](atom::algorithm::BigNumber& bn, int) -> atom::algorithm::BigNumber& {
             return ++bn;
         }, "Pre-increment operator (++bn)")
        .def("__isub__", [](atom::algorithm::BigNumber& bn, int) -> atom::algorithm::BigNumber& {
             return --bn;
