...
Examples:
    >>> client.connect("example.com", 80, 5000)  # 5 second timeout
        ...
        .def("connect_async",
             &atom::connection::TcpClient::connect_async,
             py::arg("host"), py::arg("port"), py::arg("timeout") = std::chrono::milliseconds::zero(),
    ...
    >>> client.disconnect()
        ...
        .def("send",
             [](atom::connection::TcpClient& self, py::bytes data) {
                 ...
                 std::span<const char> span_data(str_data.data(), str_data.size());
...
Examples:
    ...
    >>> client.set_on_disconnected_callback(on_disconnected)
        ...
        .def("set_on_data_received_callback",
             [](atom::connection::TcpClient& self, py::object callback) {
                 self.setOnDataReceivedCallback([callback](std::span<const char> data) mutable {
                     try {
                         py::gil_scoped_acquire acquire;
...
Examples:
    ...
    >>> client.set_on_data_received_callback(on_data)
        ...
        .def("set_on_error_callback",
             [](atom::connection::TcpClient& self, py::object callback) {
                 self.setOnErrorCallback([callback](const std::system_error& error) mutable {
                     try {
                         py::gil_scoped_acquire acquire;
...
Examples:
    ...
    >>> client.set_on_error_callback(on_error)
        ...
        .def("start_receiving",
             &atom::connection::TcpClient::startReceiving,
...
Examples:
    >>> client.start_receiving()
        ...
        .def("stop_receiving",
             &atom::connection::TcpClient::stopReceiving,
...
Examples:
    >>> client.stop_receiving()
        ...
        .def(
            "__enter__",
            [](atom::connection::TcpClient& self) -> atom::connection::TcpClient& {
                return self;
            },
